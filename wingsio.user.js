// ==UserScript==
// @name         Wings.io FLY HACK - Wingsio Hacks - Best Wings Cheat 2019 to 2020
// @description  Wings Mods Features: Auto Fly, Aimbot, Auto Heal, Auto Skin, Speed Hack, FPS, Adblock
...
// @updateURL    https://io-mods.com/mods/wingsio.user.js
// @downloadURL  https://io-mods.com/mods/wingsio.user.js
// @grant        GM_setValue
// @grant        GM_getValue
// @match        *://wings.io/*
// @match        *iogames.space/*
...
text += '<a href="http://'+value+'" target="_blank" style="'+ministyler+'">'+value2+' <font color="#555555">-</font></a>';
    ...
    //ozellikler
	var fts = ["Aimbot","Firebot","Speed Hack","Auto Heal","Auto Skin","Auto Fire","Anti Lag","Anti Ads","Unlock Weapon","Auto Fly","Auto Spawn"];
...
//degisenkisimlar
$('#mpu-top').prepend('<div style="'+this.st.formstyle+'"><div class="option1"></div></div>');
$('#copyLink').append('<div class="list1"></div>');
$('#firstRightBox').prepend('<div style="'+this.st.fpsstyle+'" id="fpsx" class="fpsx"></div>');
...
document.getElementById("howto").appendChild(styleSelect);
...
document.getElementById("howto").appendChild(stylerSelect);
